...
"""
    Base.allocated_code_bytes()

Return the total size (in bytes) of native code generated by the JIT compiler.
"""
function allocated_code_bytes()
    return Int(ccall(:jl_get_allocated_code_bytes, Csize_t, ()))
end
